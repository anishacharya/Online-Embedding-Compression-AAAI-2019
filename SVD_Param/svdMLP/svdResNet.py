...
from Layers import svdResNetLayer
...
class svdResNet():
    def __init__(self, rng, n_in, n_out, n_h, n_r,  n_layers, margin = 0.01, f_act=leaky_relu, obj='single', dropout_rate = 0):
        '''
        ...
        for i in range(n_layers-1):
            cur_hiddenLayer = svdResNetLayer(
                rng=rng,
        ...
        self.optimiser = sgd_optimizer(self, 'svdResNet')
